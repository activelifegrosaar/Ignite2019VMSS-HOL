...
def writebody():
    body = '<html><head><title>Ignite 2019 Hands-on lab</title></head>'
    body += '<body><h1>Welcome to Ignite 2019! This is a web application running on the VM scale set you just deployed</h1>'
    body += '<h2>You are viewing the worker interface on ' + hostname + '</h2><ul><h3>'

    body += 'Current worker thread status:'
